...
def router(service):
    def route(method,p,q,b,i,rid,key):
        ...
        if method=="PUT" and len(p)==4 and p[1]=="objects" and p[3]=="retention":_need(b,"tenant_id","retain_until");return service.apply_retention(i,b["tenant_id"],p[2],b["retain_until"],rid),HTTPStatus.OK
